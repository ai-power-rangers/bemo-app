...
// Detected polygons back-projected to the model plane coordinates (Y-up)
// Key: classId -> value: NSArray<NSNumber*> of [x1,y1,x2,y2,...] in plane units
@property (nonatomic, copy) NSDictionary<NSNumber*, NSArray<NSNumber*>*> *planePolygons;

// Model polygons transformed by estimated pose+scale into plane coordinates (Y-up)
// Key: classId -> value: NSArray<NSNumber*> of [x1,y1,x2,y2,...] in plane units
@property (nonatomic, copy) NSDictionary<NSNumber*, NSArray<NSNumber*>*> *planeModelPolygons;

// Per-class model color from .mtl, in RGB 0-255 triple
// Key: classId -> value: NSArray<NSNumber*> of [R,G,B]
@property (nonatomic, copy) NSDictionary<NSNumber*, NSArray<NSNumber*>*> *modelColorsRGB;
